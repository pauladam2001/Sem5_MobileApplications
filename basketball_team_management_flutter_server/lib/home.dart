    ...
    return Scaffold(
        ...
        body: Padding(
            ...
            child: FutureBuilder<List<Employee>?> (
                future: RequestManager.getEmployees(),
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                    ...
                                    onTap: () async {
                                      ...
                                      await RequestManager.updateEmployee(employee.id, employee.name, employee.age, employee.occupation, employee.salary, employee.experience);
                                      setState(() {});
                                    }
                                ),
                                GestureDetector(
        ...
        floatingActionButton: FloatingActionButton(
            onPressed: () async {
              ...
              await RequestManager.addEmployee(employee.name, employee.age, employee.occupation, employee.salary, employee.experience);
            ...
            CupertinoAlertDialog(
              ...
              actions: [
                CupertinoDialogAction(
                  ...
                  onPressed:  () async {
                    await RequestManager.deleteEmployee(index);
                    Navigator.pop(ctx);
                    setState(() {});
                  },
                ),
